      ...
      <div className='w-full' id='homeground'>
        ...
        <div className='flex'>
          <div className='w-[90vw] md:w-[15vw] h-[8rem] bg-white rounded-xl mx-auto flex flex-col justify-center p-4 text-center'>
            <h1 className='font-semibold '>Total Buses</h1>
          ...
          <div className='w-[90vw] md:w-[15vw] h-[8rem] bg-white rounded-xl mx-auto flex flex-col justify-center p-4 text-center'>
            <h1 className='font-semibold '>Total Boarding points</h1>
        ...
        <div>
          ...
          <div>
            <div className='w-[90vw] md:w-[80vw] h-full bg-white rounded-xl mx-auto flex flex-col justify-center text-center m-5'>
              <table>
                <thead className=''>
                  <tr className='bg-black/10 font-semibold text-md'>
                    <td className='py-6'>Bus no</td>
                    <td className='py-6'>routeNo</td>
                    <td className='py-6'>BoardingPointName</td>
                    <td className='py-6'>boarding Time</td>
                    <td className='py-6'>noOfSeats</td>
                  </tr>
                </thead>
                <tbody>
                  {dashboardBusDetails ? dashboardBusDetails.map((item, key) => (
                    <tr key={key} className='border-b-2 hover:bg-black/5'>
                      <td className='py-4'>{item.busNo}</td>
                      <td className='py-4'>{item.routeNo}</td>
                      <td className='py-4'>{item.BoardingPointName}</td>
                      <td className='py-4'>{item.boardingTime}</td>
                      <td className='py-4'>{item.noOfSeats}</td>
                    </tr>
                  )
